package com.egartech.authservice.config;
...
import com.egartech.authservice.config.KeycloakServerProperties.AdminUser;
...
public class EmbeddedKeycloakApplication extends KeycloakApplication {
    ...
    private void createCustomRealm() {
        ...
        try {
            ...
            LOG.warn("User Federated Storage: {}", session.userFederatedStorage());
            ...
            LOG.warn("Exception class: {}", ex.getClass());
